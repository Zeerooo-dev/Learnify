...
public class science2 extends AppCompatActivity {
    TextView question, choice1,choice2, choice3, choice4, q_text, sci_next2, sci_back1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sci_next2 = (TextView) findViewById(R.id.sci_next2);
        sci_back1 = (TextView) findViewById(R.id.sci_back1);

        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                startActivity(new Intent(science2.this, main.class));
            }
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(science2.this, MainActivity.class));
            }
        });
        ...
        sci_back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        ...
        sci_next2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(science2.this, science3.class));
            }
        });
