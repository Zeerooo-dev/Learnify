...
public class english3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Random r  = new Random();
        int x = r.nextInt(4);
        englishwelcomepage3.three = true;
        if(englishwelcomepage3.num == 1){
            eng_back2.setVisibility(View.INVISIBLE);
            eng_back2.setClickable(false);
        }
        if(englishwelcomepage3.num == 5){
            eng_next3.setText("FINISH");
        }
        ...
        eng_next3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(englishwelcomepage3.num == 5){
                    startActivity(new Intent(english3.this, englishscore.class));
                }
                else{
                    if(x == 0 && englishwelcomepage3.one){
                        englishwelcomepage3.num++;
                        englishwelcomepage3.one = false;
                        startActivity(new Intent(english3.this, english.class));
                    }
                    else if(x == 1 && englishwelcomepage3.two){
                        englishwelcomepage3.num++;
                        englishwelcomepage3.two = false;
                        startActivity(new Intent(english3.this, english2.class));
                    }
                        ...
                        startActivity(new Intent(english3.this, english5.class));
                    }
