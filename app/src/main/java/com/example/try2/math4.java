...
public class math4 extends AppCompatActivity {
    TextView question, choice1,choice2, choice3, choice4, q_text, mth_next4, mth_back3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mth_next4 = (TextView) findViewById(R.id.mth_next4);
        mth_back3 = (TextView) findViewById(R.id.mth_back3);

        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                startActivity(new Intent(math4.this, main.class));
            }
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(math4.this, MainActivity.class));
            }
        });
        ...
        choice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                choice1.setBackground(getResources().getDrawable(R.drawable.anscorrect));
        ...
        mth_back3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        ...
        mth_next4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(math4.this, math5.class));
            }
        });
